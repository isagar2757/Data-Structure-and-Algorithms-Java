...
public class ChainHashMap<K,V> extends AbstractHashMap<K,V> {
  ...
  public static void main(String[] args) {
	ChainHashMap<Integer,String> hash1 = new ChainHashMap<Integer, String>(2);
	hash1.setLoad(0.5);
	System.out.println(" Initial capacity of HashMap "+hash1.capacity);
	hash1.put(1, "A");
	System.out.println(" Elements Present: "+hash1.size()+" , capacity of HashMap "+hash1.capacity);
	hash1.put(2, "B");
	System.out.println(" Elements Present: "+hash1.size()+" , capacity of HashMap "+hash1.capacity);
	hash1.put(3, "C");
	System.out.println(" Elements Present: "+hash1.size()+" , capacity of HashMap "+hash1.capacity);
