...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  public static void main(String[] args) {
	  SortedTableMap<Integer,String> obj =  new SortedTableMap<>();
	  obj.put(1,"Abi"); obj.put(2,"Abirami"); obj.put(1,"Robert"); obj.put(3,"Kennedy");
	  
	 System.out.println( obj.containKey(1));
	 System.out.println( obj.containKey(5));
  }
