...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public Node<E> postorderNext(Node<E> node)
  {
  ...
  public int computeLengths(AbstractTree<E> T) {
	  int length=0;
  ...
  public static void main(String[] args)
  {
	  ...
	  Position<String> root =lbt.addRoot("0");
	  
	  //	  
	  Position<String> one = lbt.addLeft(root, "1");
	  Position<String> two = lbt.addRight(root, "2");
	  Position<String> three = lbt.addLeft(one, "3");
	  Position<String> four = lbt.addRight(one, "4");
	  ...
	  Position<String> nine = lbt.addLeft(six, "9");
	  Position<String> ten = lbt.addRight(six, "10");
	  //
	 ...
	 // Position<String> next = lbt.postorderNext((Node<String>) eight);
	  int pathLength = lbt.computeLengths(lbt);
	  System.out.println("path length is :"+ pathLength);
	  //System.out.println("");
	 // System.out.println("position visited after (8) in a postorder traversal : "+next.getElement());
