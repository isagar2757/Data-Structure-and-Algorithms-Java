...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public void setLoad(int load) {this.loadfactor = load;}
  public int getLoad() {return this.loadfactor;}
  ...
  public V put(K key, V value) {
    ...
    if (n > capacity*loadfactor )   // if (n > capacity / 2)              // keep load factor <= 0.5
