...
public class ArrayStack<E> implements Stack<E> {
  ...
  public static Stack<Integer> pushStack(Stack<Integer> S, Stack<Integer> T)
  {
  ...
  public static Stack<Integer> transfer(Stack<Integer> S, Stack<Integer> T){
	  ...
	  tempStack = pushStack(tempStack, T);
	  T = pushStack(T, S);
	  T = pushStack(T,tempStack);
	 

      System.out.println("Stack transfered successfully: "+ T);
  ...
  public static void main(String[] args) {
    ...
    Stack<Integer> T = new ArrayStack<>();// contents: ()
    S.push(3);                              // contents: (5)
    S.push(2); 
    S.push(1); // contents: (5, 3)
