 ...
 */
package sagarPatel_COMP254Lab1_Ex3;
  ...
  public CircularlyLinkedList<E> clone() throws CloneNotSupportedException {
    // always use inherited Object.clone() to create the initial copy
	  ...
	  if (size > 0) {                    // we need independent chain of nodes
	      ...
	      //Node<E> nullNode = null;
	     // other.addLast(null);// walk through remainder of original list
...
//main method
  public static void main(String[] args)
  {
	  ...
	  circularList.addFirst("S");
	  circularList.addLast("A");
	  circularList.addLast("G");
	  circularList.addLast("A");
	  circularList.addLast("R");
